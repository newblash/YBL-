...
class kehuInfoViewController: UIViewController, UITextFieldDelegate{
...
//        self.view.addSubview(BusinessManagerType)
        ...
        measuerHouse2 = UILabel(frame: CGRectMake(measuerHouse.frame.maxX , measuerHouse.frame.minY, mainSize.width - measuerHouse.frame.maxX - 20, 20))
        measuerHouse2.text = measuerHouse1
        measuerHouse2.font = UIFont(name: "Courier-Bold", size: 14)
        view.addSubview(measuerHouse2)
        
//        measuerHouseType = UIButton(frame: CGRectMake(measuerHouseTxt.frame.maxX + 10, measuerHouseTxt.frame.minY, 80, 20))
...
//        measuerHouseType.titleLabel?.font = UIFont.systemFontOfSize(styleType.frame.height/1.2)
...
//        self.view.addSubview(measuerHouseType)
        ...
        designer2 = UILabel(frame: CGRectMake(designer.frame.maxX , designer.frame.minY, mainSize.width - designer.frame.maxX - 20, 20))
        designer2.text = designer1
        designer2.font = UIFont(name: "Courier-Bold", size: 14)
        view.addSubview(designer2)
//        designerType = UIButton(frame: CGRectMake(designerTxt.frame.maxX + 10, designerTxt.frame.minY, 80, 20))
...
//        designerType.titleLabel?.font = UIFont.systemFontOfSize(styleType.frame.height/1.2)
...
//        self.view.addSubview(designerType)
        ...
        projectDesigin2 = UILabel(frame: CGRectMake(projectDesigin.frame.maxX , projectDesigin.frame.minY, mainSize.width - projectDesigin.frame.maxX - 20, 20))
        projectDesigin2.text = projectDesigin1
        projectDesigin2.font = UIFont(name: "Courier-Bold", size: 14)
        view.addSubview(projectDesigin2)

//        projectDesiginType = UIButton(frame: CGRectMake(projectDesiginTxt.frame.maxX + 10, projectDesiginTxt.frame.minY, 80, 20))
...
//        self.view.addSubview(projectDesiginType)
        ...
        trasactionPrice = UILabel(frame: CGRectMake(10, budget.frame.maxY + 10, 80, 20))
        ...
        trasactionPrice2 = UILabel(frame: CGRectMake(trasactionPrice.frame.maxX , trasactionPrice.frame.minY, mainSize.width - trasactionPrice.frame.maxX - 20, 20))
        trasactionPrice2.text = trasactionPrice1
        trasactionPrice2.font = UIFont(name: "Courier-Bold", size: 14)
        view.addSubview(trasactionPrice2)
...
//        record["budget"] = self.budget.text//预算价格
