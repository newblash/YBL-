...
class kehuInfo_0ViewController: UIViewController, UITextFieldDelegate{
...
//    var info = UILabel()//最后的警告信息
    ...
    override func viewDidLoad() {
        ...
        let item1 = UIBarButtonItem(title: "保存", style: UIBarButtonItemStyle.Plain, target: self, action: #selector(kehuInfo_0ViewController.save))
        navigationItem.setRightBarButtonItem(item1, animated: true)
        ...
        BusinessManagerTxt.text = BusinessManager1
        ...
        measuerHouseTxt.text = measuerHouse1
        ...
        designerTxt.userInteractionEnabled = false
        ...
        projectDesiginTxt.text = projectDesigin1
    ...
    //    }
        ...
        func save() {
            ...
            query.whereKey("createdAt", equalTo: addTime1)
//            query.whereKey("name", notEqualTo: self.nameTxt.text)
            ...
            query.findObjectsInBackgroundWithBlock({ (objects, error) in
                if error == nil {
                    for object in objects {
                        ...
                        object.setObject(self.nameTxt.text, forKey: "name")
                        object.setObject(self.addressTxt.text, forKey: "address")
                        object.setObject(self.phoneTxt.text, forKey: "phone")
                        object.setObject(self.styleTxt.text, forKey: "style")
                        object.setObject(self.colorTxt.text, forKey: "color")
                        object.setObject(self.descrTxt.text, forKey: "descr")
                        object.setObject(self.BusinessManagerTxt.text, forKey: "BusinessManager")
                        object.setObject(self.measuerHouseTxt.text, forKey: "measuerHouse")
                        object.setObject(self.designerTxt.text, forKey: "designer")
                        object.setObject(self.projectDesiginTxt.text, forKey: "projectDesigin")
                        object.setObject(self.budgetTxt.text, forKey: "budget")
